...
def delete_location(id):
    ...
    if location:
        try:
            ...
            db.session.rollback()
# filepath: c:\Users\NW\Documents\Computer Science\Yachay Tech Major\Sexto semestre\Data Bases\medicinal_plants_database\Medicinal-plants-proyect\Back and front\routes\location.py
from flask import Blueprint, request, jsonify, make_response
from models import Location, db
from schemas import LocationSchema
